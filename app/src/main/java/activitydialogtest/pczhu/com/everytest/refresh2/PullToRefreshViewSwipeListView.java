 ...
 *
 */
public class PullToRefreshViewSwipeListView extends LinearLayout {
	...
	public PullToRefreshViewSwipeListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshViewSwipeListView(Context context) {
		super(context);
		init();
	}
	...
	private boolean isRefreshViewScroll(int deltaY) {
		...
		if (mSwipeListView != null) {
			...
			if (deltaY > 0) {
				...
				View child = mSwipeListView.getChildAt(0);
				if (child == null) {
					// ���mSwipeListView��û�����,������
					return false;
				}
				if (mSwipeListView.getFirstVisiblePosition() == 0
						&& child.getTop() == 0) {
					mPullState = PULL_DOWN_STATE;
					return true;
				}
				int top = child.getTop();
				int padding = mSwipeListView.getPaddingTop();
				if (mSwipeListView.getFirstVisiblePosition() == 0
						&& Math.abs(top - padding) <= 8) // / 3
				{// ����֮ǰ��3�����ж�,�����ڲ���,��û�ҵ�ԭ��
					mPullState = PULL_DOWN_STATE;
				...
				View lastChild = mSwipeListView.getChildAt(mSwipeListView
						.getChildCount() - 1);
				if (lastChild == null) {
					// ���mSwipeListView��û�����,������
					return false;
				}
				// ���һ����view��BottomС�ڸ�View�ĸ߶�˵��mSwipeListView�����û������view,
				// ���ڸ�View�ĸ߶�˵��mSwipeListView�Ѿ����������
				if (lastChild.getBottom() <= getHeight()
						&& mSwipeListView.getLastVisiblePosition() == mSwipeListView
								.getCount() - 1) {
					mPullState = PULL_UP_STATE;
					return true;
				}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(PullToRefreshViewSwipeListView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(PullToRefreshViewSwipeListView view);
	}
}
