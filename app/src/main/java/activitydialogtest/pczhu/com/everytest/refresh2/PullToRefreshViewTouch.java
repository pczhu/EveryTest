 ...
 *
 */
public class PullToRefreshViewTouch extends LinearLayout {
	...
	public PullToRefreshViewTouch(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshViewTouch(Context context) {
		super(context);
		init();
	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(PullToRefreshViewTouch view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(PullToRefreshViewTouch view);
	}
}
